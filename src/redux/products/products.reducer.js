...
const productsReducer = (state = INITIAL_STATE, action) => {
  switch (action.type) {
    ...
    case ProductsActionsTypes.UPDATE_PRODUCT_COUNT_START:
      return {
        ...state,
        error: null,
        actionLoading: true,
    ...
    case ProductsActionsTypes.UPDATE_PRODUCT_COUNT_SUCCESS:
      return {
        ...state,
        actionLoading: false,
        error: null,
    ...
    case ProductsActionsTypes.UPDATE_PRODUCT_COUNT_RESTART:
      return {
        ...state,
        actionLoading: false,
        isSuccessful: false,
    ...
    case ProductsActionsTypes.UPDATE_PRODUCT_COUNT_FAILURE:
      return {
        ...state,
        actionLoading: false,
